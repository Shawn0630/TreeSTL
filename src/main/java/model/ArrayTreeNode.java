 ...
 * @since 1.0.0
 */
public class ArrayTreeNode<T> extends TreeNodeImplementation<T> {
    ...
    public TreeNodeIterator iterator() {
        return new TreeNodeIterator() {
            ...
            protected TreeNode<T> rightSiblingNode() {
                ArrayTreeNode<T> mParent = (ArrayTreeNode<T>) parent;
    ...
    public Collection<? extends TreeNodeImplementation<T>> siblings() {
        ...
        Collection<ArrayTreeNode<T>> siblings = new LinkedHashSet<>(parentSubtreesSize - 1);
        for (int i = 0; i < parentSubtreesSize; i++) {
            ArrayTreeNode<T> parentSubtree = (ArrayTreeNode<T>) parentSubtreeObjects[i];
