 ...
 * @since 1.0.0
 */
public class LinkedTreeNode<T> extends TreeNodeImplementation<T> {
     ...
     */
    protected LinkedTreeNode<T> leftMostNode;

    /**
     * A reference to the right sibling tree node of the current tree node
     */
    protected LinkedTreeNode<T> rightSiblingNode;
     ...
     */
    @Override
    public Collection<? extends LinkedTreeNode<T>> siblings() {
        if (isRoot()) {
        ...
        Collection<LinkedTreeNode<T>> siblings = new LinkedHashSet<>();
